...
In Casbin, an access control model is defined in a CONF file based on the **PERM metamodel (Policy, Effect, Request, Matchers)**. Switching or upgrading your authorization mechanism is as simple as modifying a configuration file. You can customize your own access control model by combining available models. For example, you can combine RBAC roles and ABAC attributes in one model and share a single set of policy rules.
