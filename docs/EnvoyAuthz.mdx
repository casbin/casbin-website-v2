...
## Usage
- Define the Casbin policies under config files by following this [guide](/docs/how-it-works).

You can verify/test your policies on online [casbin-editor](https://casbin.io/editor/).
