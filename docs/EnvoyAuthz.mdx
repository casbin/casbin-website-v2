---
id: envoy
title: Envoy (Service Mesh Authorization)
description: Authorization of Service Mesh through Envoy
keywords: [Envoy, Envoy-authz, Istio]
authors: [ashish493]
---

**[envoy-authz](https://github.com/casbin/envoy-authz)** is an Envoy external authorization service that uses Casbin for RBAC/ABAC. It implements [Envoy’s external auth gRPC API](https://www.envoyproxy.io/docs/envoy/latest/intro/arch_overview/security/ext_authz_filter.html) and works with Istio or any Envoy-based mesh.
