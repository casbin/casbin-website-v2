...
op = an `Enforce()` call; ms = milliseconds; KB = kilobytes.
...
Benchmarking for Go Casbin is implemented in
[model_b_test.go](https://github.com/casbin/casbin/blob/master/model_b_test.go).
...
Results from running `go test -bench=. -benchmem`:
...
Benchmarking for [Pycasbin](https://github.com/casbin/pycasbin) is located in
[`tests/benchmarks`](https://github.com/casbin/pycasbin/tree/master/tests/benchmarks).
...
Results from executing `casbin_benchmark`:
...
Benchmarking for [Casbin C++](https://github.com/casbin/casbin-cpp) resides in
[`tests/benchmarks`](https://github.com/casbin/casbin-cpp/tree/master/tests/benchmarks),
...
Results from the `casbin_benchmark` target built in `Release`:
...
Benchmarking for [Lua Casbin](https://github.com/casbin/lua-casbin) is implemented in
[bench.lua](https://github.com/casbin/lua-casbin/blob/master/bench.lua).
...
Results from running `luajit bench.lua`:
...
The embedded page below shows performance changes per commit.

You can also view it at: [https://v1.casbin.org/casbin/benchmark-monitoring](https://v1.casbin.org/casbin/benchmark-monitoring)
