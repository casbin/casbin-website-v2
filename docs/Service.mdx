...
| Name                                                         | Description                                                                                                                     |
|--------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------|
| [Casbin Server](https://github.com/casbin/casbin-server)     | The official "Casbin as a Service" solution based on [gRPC](https://grpc.io/). Provides both Management API and RBAC API.      |
