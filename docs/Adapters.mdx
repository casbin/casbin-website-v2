...
import {AdapterDotNETData} from "@site/src/data/AdapterData/AdapterDotNETData"; import {
  AdapterGoData
} from "@site/src/data/AdapterData/AdapterGoData";
...
import AdapterMDTable from "@site/src/data/AdapterData/AdapterMDTable";
