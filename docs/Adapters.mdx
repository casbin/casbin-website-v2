...
[DynamodDB Adapter](https://github.com/fospitia/dynamodb-adapter) | NoSQL | [fospitia](https://github.com/fospitia) | ✅ | For [Amazon Dynamodb](https://yaml.org/](https://aws.amazon.com/dynamodb/)
