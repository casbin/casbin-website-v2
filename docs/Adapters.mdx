...
[Async SQLModel Adapter](https://github.com/shepilov-vladislav/async-casbin-sqlmodel-adapter) | SQLModel | [sampingantech](https://github.com/shepilov-vladislav) | ✅ | PostgreSQL, MySQL, SQLite are supported by [sqlmodel](https://github.com/tiangolo/sqlmodel)
