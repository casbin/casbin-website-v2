...
**[Casbin.js](https://github.com/casbin/casbin.js)** brings Casbin-style access control to the frontend: define permissions (e.g. from your backend) and use them to show/hide UI or route users. It works in **manual** mode (you set permissions in code) or **auto** mode (fetch from an API).
