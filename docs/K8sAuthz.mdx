...
keywords: [K8s-authz, Kubernetes, k8s]
authors: [hsluoyz]
---
...
- Kubectl CLI
This is the [guide](https://kubernetes.io/docs/tasks/tools/install-kubectl-windows/) to setup it on Windows and this [guide](https://kubernetes.io/docs/tasks/tools/install-kubectl-linux/) for Linux.
- OpenSSL
