...
Projects that integrate Casbin for authorization. **Direct integration** = Casbin is used in the project’s codebase; **Third-party** = Casbin is used by a dependency or service.
