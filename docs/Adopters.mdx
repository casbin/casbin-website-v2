...
| [ARC API](https://github.com/sourcefuse/loopback4-microservice-catalog) | A Catalog of Microservices based on [Loopback](https://loopback.io/doc/en/lb4/) Created by [SourceFuse](https://www.sourcefuse.com/). | [Usage](https://github.com/sourcefuse/loopback4-authorization#Extension-enhancement-using-CASBIN-authorisation) | [DB adapter](https://github.com/sourcefuse/loopback4-authorization/blob/master/src/providers/casbin-authorization-action.provider.ts) |
