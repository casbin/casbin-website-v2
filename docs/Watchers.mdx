...
| [NATS, RabbitMQ, GCP Pub/Sub, AWS SNS & SQS, Kafka, InMemory](https://github.com/bartventer/casbin-go-cloud-watcher) | Messaging System | [@bartventer](https://github.com/bartventer/)  | WatcherEx based on [Go Cloud Dev Kit](https://gocloud.dev/) that works with leading cloud providers and self-hosted infrastructure |
...
| Watcher                                                          | Type     | Author                                 | Description                           |
|------------------------------------------------------------------|----------|----------------------------------------|---------------------------------------|
| [Redis Watcher](https://github.com/php-casbin/webman-permission) | KV store | [@Tinywan](https://github.com/Tinywan) | Watcher for [Redis](http://redis.io/) |
