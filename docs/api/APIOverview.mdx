...
:::note Prerequisites
Before proceeding, please ensure you understand how to install Casbin and how it works. You can find this information in the [Get Started](/docs/basics/get-started) and [How It Works](/docs/basics/how-it-works) guides.
:::
