...
Returns false if the user already has the role (also known as not affected).
...
Returns false if the user already has one of these roles (also known as not affected).
...
Returns false if the user does not have the role (also known as not affected).
...
Returns false if the user does not have any roles (also known as not affected).
...
Returns false if the user does not exist (also known as not affected).
...
Returns false if the permission does not exist (also known as not affected).
...
Returns false if the user or role already has the permission (also known as not affected).
...
Returns false if the user or role already has one of the permissions (also known as not affected).
...
Returns false if the user or role does not have the permission (also known as not affected).
...
Returns false if the user or role does not have any permissions (also known as not affected).
