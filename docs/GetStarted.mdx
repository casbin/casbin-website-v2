...
:::tip Casbin.NET v2 Features
Casbin.NET v2 brings significant improvements:

- **Async/Await Support**: Full async support for all enforcement and management APIs
- **Performance Optimizations**: Improved policy matching and caching mechanisms
- **Better Memory Management**: Reduced memory allocations and garbage collection pressure
- **Enhanced Adapters**: Support for Redis adapter and improved EFCore adapter
- **Parallel Enforcement**: Support for parallel policy evaluation
- **Strong Typing**: Better type safety with generic methods
