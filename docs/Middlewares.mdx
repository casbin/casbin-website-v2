...
[webman plugin](https://github.com/walkor/webman) | Webman for casbin plugin, Publish and subscribe Watcher based on Redis，via plugin: [webman-permission](https://github.com/php-casbin/webman-permission)
