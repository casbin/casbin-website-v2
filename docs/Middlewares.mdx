...
| [Kratos](https://github.com/go-kratos/kratos)    | Your ultimate Go microservices framework for the cloud-native era, via plugin: [kratos-casbin](https://github.com/tx7do/kratos-casbin)                                                                                                                                                                                      |
