...
[Casdoor](https://casdoor.org), a web-based management portal, handles model and policy administration:

![model editor](https://hsluoyz.github.io/casbin/ui_model_editor.png)

![policy editor](https://hsluoyz.github.io/casbin/ui_policy_editor.png)

Several third-party projects use Casbin as their authorization engine. These projects serve as starting points for building your own Casbin-powered service.
