...
Casbin follows the officially suggested way to provide authorization for GraphQL endpoints by having a single source of truth for authorization: [https://graphql.org/learn/authorization/](https://graphql.org/learn/authorization/). In other words, Casbin should be placed between the GraphQL layer and your business logic.
...
A complete list of Casbin GraphQL middlewares is provided below. Any third-party contributions of new GraphQL middleware are welcome. Please inform us, and we will add it to this list:
