...
| Test case                 | Rule size                                | Time overhead (ms/op) | Memory overhead per operation (KB) |
|---------------------------|------------------------------------------|-----------------------|----------------------|
...
| RBAC (large)              | 110000 rules (100000 users, 10000 roles) | 23.916776             | 7606                 |
...
```text
AMD Ryzen(TM) 5 4600H CPU @ 3.0 GHz, 6 Cores, 12 Threads
```
