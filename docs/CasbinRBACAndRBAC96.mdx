...
RBAC2|  mutually exclusive handling is supported ([like this](https://casbin.io/docs/syntax-for-models#policy-effect)), but quantitative limits are not|RBAC2 added constrains on RBAC0. So RBAC2 can handle mutually exclusions found in policies.
RBAC3| mutually exclusive handling is supported ([like this](https://casbin.io/docs/syntax-for-models#policy-effect)), but quantitative limits are not| RBAC3 is a combination of RBAC1 and RBAC2. RBAC3 supports role hierarchies and constrains in RBAC1 and RBAC2.
