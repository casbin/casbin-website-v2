...
Role inheritance cycles can break RBAC logic. Use the `Detector` interface to validate your role graph and catch cycles before they cause issues. See the [Cycle Detection](/docs/cycle-detection) section for details.
