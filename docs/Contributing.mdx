...
* **Use Casbin and report issues!** When using Casbin, report issues to promote development of Casbin, no matter bugs or proposal. Before file an issue on GitHub, it would be better to discuss first on [Discord](https://discord.gg/S5UjpzGZjN) or [GitHub Discussions](https://github.com/casbin/casbin/discussions)
