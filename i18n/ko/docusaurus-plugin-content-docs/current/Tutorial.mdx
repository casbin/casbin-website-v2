...
- [Casbin에서 PERM으로 권한 부여(Authorization) 모델링하기](https://narendraj9.github.io/posts/generalized-authz.html)
...
- [Casbin을 황룔한 Argo CD에서의 조직 역할-기반 접근제어 구성](https://argo-cd.readthedocs.io/en/stable/operator-manual/rbac/)
