...
| RBAC + 리소스 역할  | 6 rules (2 users, 2 roles)               | 0.021146              | 7.906                |
| RBAC + 도메인/테넌트 | 6 rules (2 users, 1 role, 2 domains)     | 0.032696              | 10.755               |
| ABAC           | 0 rule (0 user)                          | 0.007510              | 2.328                |
| RESTful        | 5 rules (3 users)                        | 0.045398              | 91.774               |
| 거부(Deny) 우선    | 6 rules (2 users, 1 role)                | 0.023281              | 8.370                |
| 우선순위           | 9 rules (2 users, 2 roles)               | 0.016389              | 5.313                |
...
| RBAC + 리소스 역할  | 6 rules (2 users, 2 roles)               | 0.03                  |
| RBAC + 도메인/테넌트 | 6 rules (2 users, 1 role, 2 domains)     | 0.041                 |
| ABAC           | 0 rule (0 user)                          | NA                    |
| RESTful        | 5 rules (3 users)                        | NA                    |
| 거부(Deny) 우선    | 6 rules (2 users, 1 role)                | 0.0246                |
| 우선순위           | 9 rules (2 users, 2 roles)               | 0.035                 |
...
| RBAC + 리소스 역할  | 6 rules (2 users, 2 roles)               | 0.1124                |
| RBAC + 도메인/테넌트 | 6 rules (2 users, 1 role, 2 domains)     | 0.1978                |
| ABAC           | 0 rule (0 user)                          | 0.0305                |
| RESTful        | 5 rules (3 users)                        | 0.1085                |
| 거부(Deny) 우선    | 6 rules (2 users, 1 role)                | 0.1934                |
| 우선순위           | 9 rules (2 users, 2 roles)               | 0.1437                |
